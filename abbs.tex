...
\newcommand{\articletitle}{A General Scheme for Generating NMR Supersequences Combining High- and Low-Sensitivity Experiments}
...
The pulse programmes and processing scripts used in this work can be obtained via the Bruker User Library or GitHub; links are provided in \cref{sec:pp_availability} of the \textit{Supplementary Information}.
...
{\singlespacing
\begin{tcbminted}{text}
# Generalised indirect covariance
import penguins as pg
import numpy as np
